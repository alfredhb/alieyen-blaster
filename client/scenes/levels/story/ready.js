...
export default class StoryReadyScene extends Phaser.Scene {
    ...
    navigationSection(width, height) {
        ...
        const storyButton = this.add.image(width * 0.675, height * 0.65, '__WHITE');
        const playText = this.add.text(width * 0.325, height * 0.65, 'PLAY', this.constants.MenuButtonStyle());
        const storyText = this.add.text(width * 0.675, height * 0.65, 'STORY', this.constants.MenuButtonStyle());
