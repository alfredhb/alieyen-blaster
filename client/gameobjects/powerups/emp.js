...
export default class EMP extends Phaser.Physics.Arcade.Sprite {
    constructor(scene) {
        super(scene, -50, -50, 'lightning');
        ...
        this.setDisplaySize(width * 0.1, width * 0.1);
        this.setSize(this.width * 0.9, this.height * 0.9);
        this.setOrigin(0.5);

        this.maxX = width + 65;
        this.maxY = height + 65;
        this.empDuration = 7500; //7.5 seconds
    ...
    collisionFunc(p, b) {
        ...
        this.scene.events.emit('emp', (this.empDuration /* duration in ms */));
