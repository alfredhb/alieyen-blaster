...
export default class Slow extends Phaser.Physics.Arcade.Sprite {
    constructor(scene) {
        super(scene, -50, -50, 'slow');
        ...
        this.setDisplaySize(width * 0.12, width * 0.12);
        this.setSize(this.width * 0.9, this.height * 0.9);
        this.setOrigin(0.5);

        this.maxX = width + 65;
        this.maxY = height + 65;
        this.slowDownDuration = 7500; //7.5 seconds
    ...
    collisionFunc(p, b) {
        ...
        this.scene.events.emit('slowaliens', (this.slowDownDuration /* duration in ms */));
